...
class TaskManager:
        ...
        while True:
            ...
            try:
                ...
                if datetime_obj < datetime.now():
                    console.print("\nError: Invalid date and time. It should be in the future.", justify='center', style='red')
                    logging.info("Error: Invalid date and time. It should be in the future.")
                    continue
                return datetime_obj
            except ValueError:
                console.print("\nError: Invalid date format. Please enter the date and time in the format YYYY-MM-DD HH:MM.", justify='center', style='red')
    ...
    def print_create_task(self):
        ...
        console.print("     ___ ____   ____  ___  ______  ____    ______  ___   __  __ __", justify='left', style='blink bold yellow')
        console.print("[yellow]    //   || \\\ ||    // \\\ | || | ||       | || | // \\\ (( \ || // [/yellow]", justify='left', style='blink bold yellow')
        console.print("[yellow]   ((    ||_// ||==  ||=||   ||   ||==       ||   ||=||  \\\  ||<<  [/yellow]", justify='left', style='blink bold yellow')
        console.print("[yellow]    \\__  || \\\ ||___ || ||   ||   ||___      ||   || || \_)) || \\\ [/yellow]", justify='left', style='blink bold yellow')
    ...
    def create_task(self, username, selected_project):
        ...
        if selected_project['owner'] != username:
            console.print("Error: You do not have permission to create tasks for this project.", justify='center', style='red')
        ...
        while True:
            ...
            if label.strip():
                ...
                console.print("Error: Task label cannot be empty. Please enter a label.", justify='center', style='bold red')
        ...
        while True:
            ...
            if not member_choices:
                console.print("No members selected for the task. You can add members later.", justify='center', style='bold red')
                logging.info("Error: No members selected for the task. You can add members later.")
                console.print("Do you want to proceed without assigning any members? (y/n): ", justify='center', style='red underline')
                proceed = input()
                if proceed.lower() != 'y':
        ...
        while True:
            ...
            if priority.isdigit() and 1 <= int(priority) <= 4:
                ...
                console.print("Error: Invalid input. Please choose a priority between 1 and 4.", justify='center', style='bold red')
                logging.info("Error: Invalid input.")
        ...
        while True:
            ...
            if status.isdigit() and 1 <= int(status) <= 5:
                ...
                console.print("Error: Invalid input. Please choose a status between 1 and 5.", justify='center', style='bold red')
                logging.info("Error: Invalid input.")
        ...
        while True:
            ...
            if choice == '1':
                ...
                if username == selected_project["owner"] or username in selected_task["assignees"]:
                    ...
                    console.print("Enter new title (leave blank to remove current title): ", justify='center', style='white')
                    new_title = input()
                    if new_title:
                    ...
                    console.print("Error: You are not allowed to change this section.", justify='center', style='bold red')
                ...
                if username == selected_project["owner"] or username in selected_task["assignees"]:
                    ...
                    console.print("Enter new description (leave blank to remove current description): ", justify='center', style='white')
                    ...
                    while True:  # Loop until valid choice is made
                        ...
                        if assignee_choice == '1':
                            ...
                            if not available_assignees:
                                console.print("Error: There are no available assignees to add.", justify='center', style='bold red')
                            ...
                            console.print("\nEnter the numbers of the assignees to add (comma-separated): ", justify='center', style='white')
                            ...
                            if not selected_task["assignees"]:
                                console.print("Error: There are no assignees to remove.", justify='center', style='bold red')
                            ...
                            console.print("Enter the numbers of the assignees to remove (comma-separated): ", justify='center', style='white')
                            selected_assignees = input().split(',')
                            selected_assignees = [int(x.strip()) - 1 for x in selected_assignees if re.match("^\d+$", x.strip())]
                ...
                if username == selected_project["owner"] or username in selected_task["assignees"]:
                    ...
                    console.print("  ", justify='center')
                    console.print("Choose priority (1-4) or press Enter to keep current priority: ", justify='center', style='white')
                    ...
                    if new_priority_choice.isdigit() and 1 <= int(new_priority_choice) <= 4:
                        ...
                        console.print("Error: Invalid priority choice. Please choose a number between 1 and 4.", justify='center', style='bold red')
                ...
                if username == selected_project["owner"] or username in selected_task["assignees"]:
                    ...
                    console.print("\nChoose status (1-5) or press Enter to keep current status: ", justify='center', style='white')
                    ...
                    if new_status_choice.isdigit() and 1 <= int(new_status_choice) <= 5:
                        ...
                        console.print("Error: Invalid status choice. Please choose a number between 1 and 5.", justify='center', style='bold red')
    ...
    def delete_task(self, username, selected_project):
        ...
        if selected_project['owner'] != username:
            console.print("Error: You do not have permission to delete tasks for this project.", justify='center', style='bold red')
        ...
        if not selected_task_index.isdigit() or int(selected_task_index) < 1 or int(selected_task_index) > len(user_tasks):
            console.print("Error: Invalid task selection. Please enter a valid task number.", justify='center', style='bold red')
    ...
    def view_tasks(self, selected_project, username):
        ...
        while True:
            try:
                console.print("Enter the number of the task you want to view or edit: ", justify='center', style='bold white')
                task_choice = int(input())
                if task_choice in label_to_number.values():
                    break
                else:
                    console.print("Error: Invalid number. Please enter a valid task number.", justify='center', style='bold red')
        ...
        while True:
            ...
            if menu_choice == '1':
                ...
                try:
                    ...
                    table.add_row()
                    deadline_formatted = datetime.fromisoformat(selected_task.get('deadline')).strftime("%Y-%m-%d %H:%M") if selected_task.get('deadline') else 'N/A'
