...
class TestProjectManager(unittest.TestCase):
    ...
    def test_remove_member_from_project_success(self):
        ...
        self.project_manager.remove_member_from_project(project_id, username)
    ...
    def test_remove_member_from_project_not_member(self):
        ...
        result = self.project_manager.remove_member_from_project(project_id, username)
    def test_remove_member_from_project_not_owner(self):
        project_id = "1"
        username = "not_owner"
        member_to_remove = "q"
        self.project_manager.remove_member_from_project(project_id, username)
        self.assertEqual(self.project_manager.remove_member_from_project(project_id, username), None)
